...
if fit_k == 1
    ...
    [prs,dev,stats] = glmfit([yconvhi],reshape(y,[],1),'poisson','constant','off');
end
...
if fit_k == 1
    ...
    h = hbasis*prs(1:end); % k basis functions weighted by given parameters
end
dc = 0; % dc current (accounts for mean spike rate)
